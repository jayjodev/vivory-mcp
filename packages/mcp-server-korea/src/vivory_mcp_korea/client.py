...
USER_AGENT = "vivory-mcp-korea/0.5.0 (+https://vivory.app)"
...
def get_api_key() -> str | None:
    ...
    Sign up at https://api.vivory.app/dashboard. The MCP server runs
...
async def get(path: str, params: dict[str, Any] | None = None, not_found_ok: bool = False) -> dict | list:
    ...
    if resp.status_code == 429:
        raise RuntimeError(
            ...
            "https://api.vivory.app/dashboard) to upgrade."
        )
